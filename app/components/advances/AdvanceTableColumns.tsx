...
import { formatDateToLcateDateString } from "../../utils/dateFormats";
    ...
    Other: [
      ...
      },
      {
        ...
        cell: (row: Advance) => (
          <div className="d-flex align-items-center gap-2">
            ...
            <span>
              {
                findObjectFromArray(imprestTypes, "code", row.imprestType)
      ...
      },
      {
        ...
        cell: (row: Advance) => (
          <span
            className={`badge ${
              issuedStatus.includes(row.imprestStatus)
                ? "bg-success-subtle text-success"
                : "bg-secondary-subtle text-muted"
            }`}
          >
